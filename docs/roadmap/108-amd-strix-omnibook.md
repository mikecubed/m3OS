...
**Depends on:** Phase 96 (bare-metal bring-up + boot rescue) ✅, Phase 55a/67 (AMD-Vi IOMMU coded + host-tested) ✅, Phase 81 (mt792x connac2 Wi-Fi) ✅, Phase 102 (I2C-HID protocol layer — Track D backend), Phase 104 (Wi-Fi supplicant daemon — Track A reuse), Phase 107 (Networked & Signed Package Distribution — sequencing prerequisite: the OmniBook line starts only after the full Dell line 99–107 proves the stack)
