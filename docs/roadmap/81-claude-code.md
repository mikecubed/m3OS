...
**Status:** Planned
**Source Ref:** phase-81
**Depends on:** Phase 78 (Cross-Compiled Toolchains) ✅, Phase 79 (Networking and GitHub) ✅, Phase 80 (Node.js) ✅
...
|---|---|---|
| Runtime baseline | Phase 80 provides the documented Node/npm environment needed by the tool | Pull missing runtime or packaging work into this phase |
...
- Create `docs/81-claude-code.md` using the aligned learning-doc template in `docs/appendix/doc-templates.md`.
...
- Phase 81 task list — defer until implementation planning begins.
