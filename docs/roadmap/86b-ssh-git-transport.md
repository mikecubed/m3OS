...
- Non-blocking-connect and TCP reassembly hardening (`sys_connect`'s 3 s cap; `kernel/src/net/tcp.rs:20` drops out-of-order payload) — a lossy-SLIRP clone risk noted but not fixed here.
