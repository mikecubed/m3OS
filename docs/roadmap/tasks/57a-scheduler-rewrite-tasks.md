...
- The two source handoff docs (`docs/handoffs/2026-04-25-scheduler-design-comparison.md` and `docs/handoffs/2026-04-28-graphical-stack-startup.md`) are the input specification for this phase; they are not modified.
