...
| D | Realtek RTL8125 2.5GbE (hardware-only) | C | ✅ Complete — **real-silicon `ping` PASS** over a physical RTL8125B, operator-observed via VFIO passthrough (ICMP reply from the LAN gateway); manual hardware result, not a CI gate |
