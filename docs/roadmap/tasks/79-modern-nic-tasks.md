...
- [ ] (hardware-only — physical RTL8125 card required; not present on this bench) On a real RTL8125 card, `ping` succeeds. *Code path complete + host-tested; gated solely by physical hardware.*
