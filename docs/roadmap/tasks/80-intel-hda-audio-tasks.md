...
| 80c | F | Real-hardware bring-up on the dev laptop (hardware-only) | E | ⏳ HW confirmed present (ALC1220 @ 1022:15e3, isolated IOMMU grp) + matches driver; turnkey runbook landed; only the root-VFIO + human-listen step remains (operator-only) |
