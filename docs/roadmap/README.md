...
| 80 | Intel HDA Audio (+ Realtek codec family) | Out-of-process ring-3 HDA + extracted AC'97 drivers behind a new `driver_ipc::audio` seam; `audio_server` demoted to a pure policy/mixer server (no kernel facade). Realtek ALC888/892/1220 codecs. Splittable 80a/80b/80c. | Planned | `phase-80` | [Phase 80](./80-intel-hda-audio.md) | [Tasks](./tasks/80-intel-hda-audio-tasks.md) |
