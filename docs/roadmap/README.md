...
| 78 | USB Host Foundation (xHCI + Hub + HID) | Ring-3 xHCI driver + USB core + HID class; modern laptops/desktops without PS/2 get keyboard and mouse input. Single biggest 1.0 unblocker. | Planned | `phase-78` | [Phase 78](./78-usb-host-foundation.md) | [Tasks](./tasks/78-usb-host-foundation-tasks.md) |
