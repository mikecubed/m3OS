...
| 74a | Pre-1.0 Audit and Release Blocker Inventory | Source-verified inventory of every deferred / handoff / post-mortem item still standing between phase 74 and a real-hardware 1.0; grades USB-HID, modern NIC, Wi-Fi, HDA, AHCI, W^X, fat_server, Spectre mitigations as blockers; proposes phases 74b–74h. Feeds Phase 77. | Planned | `phase-74a` | [Phase 74a](./74a-pre-1.0-audit.md) | _(audit doc — no task list)_ |
