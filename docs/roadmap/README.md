...
| 36 | Expanded Memory | Demand paging, mprotect, large mmap, disk/RAM expansion | Planned | `phase-36` | [Phase 36](./36-expanded-memory.md) | [Tasks](./tasks/36-expanded-memory-tasks.md) |
