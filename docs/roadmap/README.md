...
| 39 | Unix Domain Sockets | AF_UNIX stream/datagram, socketpair | Planned | `phase-39` | [Phase 39](./39-unix-domain-sockets.md) | [Tasks](./tasks/39-unix-domain-sockets-tasks.md) |
