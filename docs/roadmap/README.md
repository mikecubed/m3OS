...
| 82 | AHCI / SATA Storage | Optional pre-1.0 SATA driver for systems without NVMe. Defer to post-1.0 if the rest of 77–81 slips. | Planned (optional) | `phase-82` | [Phase 82](./82-ahci-sata.md) | [Tasks](./tasks/82-ahci-sata-tasks.md) |
