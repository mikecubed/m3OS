...
| 91 | IPv6 / DHCPv6 | Dual-stack IPv6 layered on top of the IPv4-only 1.0 network promise: `Ipv6Addr` + header framing, ICMPv6 + NDP (ARP's v6 replacement), SLAAC + a DHCPv6 client, an `AF_INET6`/`sockaddr_in6` socket surface, AAAA resolution + RFC 6724 selection, and a `ping6` tool. | Planned | `phase-91` | [Phase 91](./91-ipv6-dhcpv6.md) | [Tasks](./tasks/91-ipv6-dhcpv6-tasks.md) |
