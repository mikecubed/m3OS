...
| [Spectre / KPTI Mitigations](./84-spectre-mitigations.md) | 84 | Post-1.0 transient-execution hardening — KPTI (Meltdown), retpoline (Spectre-v2 BTI), IBRS/eIBRS/IBPB/STIBP, `mitigations=off\|auto\|full` boot policy, host-tested CPUID/MSR decode, and an honest accounting of the UNADDRESSED classes (MDS, L1TF, SSB, Retbleed, Downfall) |
