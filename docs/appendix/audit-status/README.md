...
| `08-supplemental-findings.md` | **Supplemental pass 2026-05-08** — covers the missed subdirs (`docs/debug/`, `docs/evaluation/`, `docs/handoffs/`, `docs/handoffs/`, `docs/post-mortems/`, `docs/research/`, `docs/shell/`, top-level legacy `docs/*.md`). 3 new 🛑 blockers + 3 new 🔴 items + 1 audit residual closed |
