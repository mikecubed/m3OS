...
| `docs/handoffs/` (singular) | Per-handoff, 1 file only | Likely deprecated (single file: 2026-04-28-graphical-stack-startup) |
...
2. Migrate `docs/handoffs/` (singular) into `docs/handoffs/` (plural) and remove the empty directory; or vice-versa.
