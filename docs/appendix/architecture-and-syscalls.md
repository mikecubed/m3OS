...
| 0x1100–0x1114 | ipc_* | ipc | Mechanism | IPC operations dispatched through `kernel/src/ipc/mod.rs`; maps userspace `0x1100`–`0x1114` to internal dispatch 1–21 (includes recv/send/call/reply, cap_grant, notifications, service register/lookup, bulk reply drains, non-blocking recv, and cap-free service-existence queries) |
