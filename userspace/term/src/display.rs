...
impl DisplayClient {
    ...
    /// `SetSurfaceRole(Toplevel)` round-trip, allocate **two** ~4 MiB
    /// shared-memory regions (front + back) sized for the 1280 × 800
    /// BGRA8888 surface, and return a ready-to-submit `DisplayClient`.
    ///
